...
insert into users (name, login, password, birthday, email, enabled, ROLE_ID) VALUES('Zavoruyev', 'Zavoruyev', 'admin', '1986-08-15','zavoruev@gmail.com', true, 1)
insert into users (name, login, password, birthday, email, enabled, ROLE_ID) VALUES('AZavoruyev', 'AZavoruyev', '$2a$10$RfpUhq/sOlN8e2j0JSRZZeCyCCmA06XC88dFGVYpA9NrFGqN46Wcu', '1986-08-15','azavoruev@gmail.com', true, 1)
...
update users set first_Name='Admin', last_Name='Rootmaster' where id=2
