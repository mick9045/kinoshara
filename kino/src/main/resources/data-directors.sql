...
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (2, 'Inception', 'inception.jpg', 2010, 0)
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (3, 'Thor 3: Ragnarok', 'thor_3.jpg', 2017, 0)
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (4, 'Avengers', 'avengers_3.jpg', 2018, 0)
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (5, 'Green Mile', 'green_mile.jpg', 1999, 0)
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (6, 'Interstellar', 'Interstellar.jpg', 2014, 0)
insert into films(id, title, image_Small_Path, release_Year, views) VALUES (7, 'Midnight sun', 'midnight_sun.jpg', 2018, 0)
...
insert into reviews(id, review) values (3, 'Its Brilliant')
insert into reviews(id, review) values (4, 'You are all suck')
insert into reviews(id, review) values (5, 'Hate it')
insert into reviews(id, review) values (6, 'Best movie ever')

insert into films_reviews(film_id, reviews_id) values (1, 1)
insert into films_reviews(film_id, reviews_id) values (1, 2)
insert into films_reviews(film_id, reviews_id) values (1, 3)
insert into films_reviews(film_id, reviews_id) values (1, 4)
insert into films_reviews(film_id, reviews_id) values (1, 5)
insert into films_reviews(film_id, reviews_id) values (1, 6)
